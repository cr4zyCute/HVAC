...
description: Senior full-stack engineer master skill for adding a secure, usable, server-backed admin panel to an existing site. Covers architecture decisions (Astro SSR/hybrid, SQLite/Postgres DB, Headless CMS), OWASP authentication standards, role-based access control (RBAC), data modeling, operational UX patterns, audit logging, and security verification.
---
